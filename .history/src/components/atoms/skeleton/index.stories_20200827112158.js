...
export const SkeletonWithCircle = () => <Skeleton circle width="40px" height={40}></Skeleton>;

export const SkeletonWithStyle = () => <Skeleton style={{ border: "2px solid red" }} height={40}></Skeleton>;
