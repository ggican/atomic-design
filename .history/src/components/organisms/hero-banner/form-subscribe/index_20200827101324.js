        ...
        <Card>
            <Grid imageUrl="https://img.icons8.com/bubbles/2x/t-shirt.png">
                ...
                <Grid.Col lg={9} sm={9} xs={12} md={9}>
                    ...
                    <<Text className="TItle">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi quae aliquam laudantium totam quisquam eum corrupti repellendus! Iste maxime, quisquam asperiores voluptas reiciendis quam? Incidunt dolore dolores velit ullam impedit.</Text></Text.TItle>
                </Grid.Col>
            </Grid>
            <Grid imageUrl="https://img.icons8.com/bubbles/2x/t-shirt.png">
                <Grid.Col lg={3} sm={3} xs={12} md={3}>
