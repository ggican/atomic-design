...
const CardMoves = props => {
    const { randomBackground, width } = props;
    ...
    return (
        ...
        >
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut unde inventore repellat laboriosam itaque
            dignissimos sed. Distinctio aliquid, expedita nesciunt cupiditate voluptatibus consectetur, animi porro quod
            eligendi id, quas ad?
