...
export const WithIcon = () => {
    return (
        <div>
            ...
            <div style={{ width: "100%", display: "block", marginBottom: 10 }}>
                <Button box iconPosition="top" color="white" icon={<IoMdSend size={24} />}></Button>
            </div>

            <div style={{ width: "100%", display: "block", marginBottom: 10 }}>
                <Button block size="sm" color="link" icon={<IoIosArrowBack />}>
                    Back
                </Button>
            </div>
            <div style={{ width: "100%", display: "block", marginBottom: 10 }}>
                <Button block size="sm" iconPosition="right" color="link" icon={<IoIosArrowForward />}>
                    See more
                </Button>
            </div>
        </div>
